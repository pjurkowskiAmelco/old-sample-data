...
function apply_dir () {
    ...
    java -cp ${CURRENT_JAR} ats.betsync.in.replay.BetsyncInMessageReplayTool -delay 100 -username betsyncfrontenduser -password test1 -url http://localhost:8120/betsync-proxy/in/ -msg data/${chosenFeed}/${chosenSport}/$d
}
